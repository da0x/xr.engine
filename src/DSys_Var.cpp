...
------------
	...
	$Id: DSys_Var.cpp,v 1.4 2004/07/31 19:22:02 Daher Alfawares Exp $
	$Name:  $
...
//		this->sval		= 0;
	...
	bool Var::compare( std::string vname)
	{
		...
		return strcmpi( this->name.c_str(), vname.c_str());
#pragma message ("What the fuck is this stupid shit, Umma kick stl if this is real... dumbshitfuckass O_O")
	}
